module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener ` chamada do quarto argumento válido." ],
      ...
      "Your JSON file could not be parsed.":[ "O seu arquivo JSON não pôde ser analisado." ],
      ...
      "File is too large to parse.":[ "O arquivo é muito grande para analisar." ],
      ...
      "Violation of Mozilla conditions of use.":[ "Violação das condições de uso da Mozilla." ],
      ...
      "A custom content_security_policy needs additional review.":[ "É necessário revisão adicional para o content_security_policy personalizado." ],
      "The \"name\" property must be a string.":[ "A propriedade \"name\" deve ser uma string." ],
      "See http://mzl.la/1STmr48 (MDN Docs) for more information.":[ "Veja http://mzl.la/1STmr48 (Documentação MDN) para mais informações." ],
      "The \"version\" property must be a string.":[ "A propriedade \"versão\" deve ser uma string." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Veja http://mzl.la/1kXIADa (MDN Docs) para mais informação." ],
      "The \"version\" property uses a Firefox-specific format.":[ "A propriedade \"version\" usa um formato específico do Firefox." ],

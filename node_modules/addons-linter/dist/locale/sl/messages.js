module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Violation of Mozilla conditions of use.":[ "Kršitev Mozillinih pogojev uporabe." ],
      ...
      "A custom content_security_policy needs additional review.":[ "content_security_policy po meri potrebuje dodaten pregled." ],
      "The \"name\" property must be a string.":[ "Lastnost \"name\" mora biti niz." ],
      "See http://mzl.la/1STmr48 (MDN Docs) for more information.":[ "Za več informacij glejte http://mzl.la/1STmr48 (dokumente na MDN-u)." ],
      "The \"version\" property must be a string.":[ "Lastnost \"version\" mora biti niz." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Za več informacij glejte http://mzl.la/1kXIADa (dokumente na MDN-u)." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Lastnost \"version\" uporablja obliko, posebno za Firefox." ],

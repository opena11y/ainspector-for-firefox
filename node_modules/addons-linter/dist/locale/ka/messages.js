module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Your JSON contains block comments.":[ "თქვენი JSON შეიცავს მრავალხაზიან კომენტარებს." ],
      ...
      "Flagged file type found":[ "აღმოჩენილია გასაჩივრებული ფაილის ტიპი" ],
      "Package already signed":[ "პაკეტი უკვე დამოწმებულია" ],
      "Violation of Mozilla conditions of use.":[ "Mozilla-ს გამოყენების პირობების დარღვევა." ],
      "Package contains duplicate entries":[ "პაკეტი შეიცავს გაორმაგებულ ერთეულებს" ],
      ...
      "An icon defined in the manifest could not be found in the package.":[ "მანიფესტში განსაზღვრული ხატულა, პაკეტში ვერ მოიძებნა." ],
      "Icon could not be found at \"%(path)s\".":[ "ხატულა, ვერ მოიძებნა „%(path)s“ მისამართზე." ],
      "Background script could not be found at \"%(path)s\".":[ "ფონური სკრიპტი ვერ მოიძებნა „%(path)s“ მისამართზე." ],
      "Background page could not be found at \"%(path)s\".":[ "ფონური გვერდი ვერ მოიძებნა „%(path)s“ მისამართზე." ],
      "The field is invalid.":[ "ველი არამართებულია." ],
      "Content script defined in the manifest could not be found at \"%(path)s\".":[ "მანიფესტში განსაზღვრული შიგთავსის სკრიპტი, ვერ მოიძებნა „%(path)s“ მისამართზე." ],
      "Content script css file defined in the manifest could not be found at \"%(path)s\".":[ "მანიფესტში განსაზღვრული შიგთავსის სკრიპტის css ფაილი, ვერ მოიძებნა \"%(path)s\" მისამართზე." ],
      ...
      "The \"default_locale\" is missing localizations.":[ "„ნაგულისხმევი ენა“ ვერ მოიძებნა არსებულ ენებში." ],
      "The \"default_locale\" is missing but \"_locales\" exist.":[ "„ნაგულისხმევი ენა“ ვერ მოიძებნა, თუმცა „_locales“ არსებობს." ],

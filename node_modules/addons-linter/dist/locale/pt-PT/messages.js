module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "File is too large to parse.":[ "O ficheiro é muito grande para analisar." ],
      ...
      "Violation of Mozilla conditions of use.":[ "Violação das condições de utilização da Mozilla." ],
      ...
      "See https://mzl.la/1ZOhoEN (MDN Docs) for more information.":[ "Ver https://mzl.la/1ZOhoEN (MDN Docs) para mais informação." ],
      ...
      "Content script defined in the manifest could not be found at \"%(path)s\".":[ "O script de conteúdo definido no manifesto não pôde ser encontrado em \"%(path)s\"." ],
      "Content script css file defined in the manifest could not be found at \"%(path)s\".":[ "O ficheiro de css do script de conteúdo definido no manifesto não pôde ser encontrado em \"%(path)s\"." ],
      ...
      "Icons must be square.":[ "Os ícones têm de ser quadrados." ],
      "Icon at \"%(path)s\" must be square.":[ "O ícone em \"%(path)s\" tem de ser quadrado." ],
      ...
      "Expected icon file at \"%(path)s\" is corrupted":[ "O ficheiro de ícone esperado em \"%(path)s\" está corrompido" ],
      ...
      "Icons should be one of JPG/JPEG, WebP, GIF, PNG or SVG.":[ "Os ícones devem ser um de JPG/JPEG, WebP, GIF, PNG ou SVG." ],
